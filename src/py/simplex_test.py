...
def test_simplex_decoder_predicts_various_observable_flips(decoder_class, config_class):
...
def test_simplex_decode(decoder_class, config_class):
...
def test_simplex_decode_complex_dem(decoder_class, config_class):
...
def test_simplex_decode_batch_with_invalid_dimensions(decoder_class, config_class):
...
def test_simplex_decode_batch(decoder_class, config_class):
