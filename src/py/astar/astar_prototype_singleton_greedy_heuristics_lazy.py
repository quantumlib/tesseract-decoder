...
class GreedySingletonHeuristicDecoder:
    ...
    def compute_support_based_heuristic(
        ...
        *,
        ...
        return self.evaluate_named_heuristic(support_data, name or self.heuristic_name)
    ...
    def _maybe_refine_node(self, state: SearchState) -> Tuple[SearchState, bool]:
        ...
        if self.heuristic_name == "exact_lp" and new_value + 1e-7 < state.h_cost:
        ...
        # Non-improving greedy recomputation: keep the existing projected feasible point.
        if previous_source == "projected":
            self.projected_nodes_refined += 1
