...
def test_create_config():
    assert (
        ...
        == "TesseractConfig(dem=DetectorErrorModelObject, det_beam=65535, no_revisit_dets=0, at_most_two_errors_per_detector=0, verbose=0, pqlimit=18446744073709551615, det_orders=[], det_penalty=0)"
    )
